package cc.qianlang.aiclassroom.proxy.zai.asr.v4;

import cc.qianlang.aiclassroom.proxy.zai.asr.v4.request.TranscriptionRequest;
import cc.qianlang.aiclassroom.proxy.zai.asr.v4.response.TranscriptionResponse;
import cc.qianlang.aiclassroom.proxy.zai.asr.v4.response.TranscriptionStreamChunk;
...
public class ZaiAsrClient {
	...
	public TranscriptionResponse transcribe(TranscriptionRequest request) {
		...
		TranscriptionResponse response = this.webClient.post()
				.uri("/paas/v4/audio/transcriptions")
