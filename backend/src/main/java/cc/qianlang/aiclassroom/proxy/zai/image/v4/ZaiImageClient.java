package cc.qianlang.aiclassroom.proxy.zai.image.v4;

import cc.qianlang.aiclassroom.proxy.zai.image.v4.request.ImageRequest;
import cc.qianlang.aiclassroom.proxy.zai.image.v4.response.ImageGenerationResponse;
...
public class ZaiImageClient {
	...
	public ImageGenerationResponse generate(ImageRequest request) {
		...
		ImageGenerationResponse response = this.webClient.post()
				.uri("/paas/v4/images/generations")
